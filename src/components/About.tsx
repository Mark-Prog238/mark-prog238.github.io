...
export default function About() {
  return (
    <section id="about" className="py-16 sm:py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12">
          ...
          >
            <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-blue-600">Who am I?</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              {[
                { 
                  ...
                  icon: (
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-blue-500 mb-3 sm:mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                { 
                  ...
                  icon: (
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-green-500 mb-3 sm:mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                { 
                  ...
                  icon: (
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-purple-500 mb-3 sm:mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                { 
                  ...
                  icon: (
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-yellow-500 mb-3 sm:mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <motion.div 
                  key={index}
                  className={`bg-white p-4 sm:p-6 rounded-lg shadow-md border-l-4 ${item.borderColor} hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer`}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
